...
def cm_local(x, u, w, aero_coefs_pp, ders, alff, alff_x, alff_u):
    # tck = UnivariateSpline._eval_args(aero_coefs_pp.cm)
    ...
    breaks = aero_coefs_pp[0][0][3][0][0][1]
    assert breaks.shape == (1, 541)

    coeffs = aero_coefs_pp[0][0][3][0][0][2]
